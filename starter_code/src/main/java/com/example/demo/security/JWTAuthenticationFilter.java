...
import com.example.demo.model.constants.SecurityConstants;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest req, HttpServletResponse res) throws AuthenticationException {
        try {
            ...
            log.info("AttemptAuthentication for user {}", credentials.getUsername());
            ...
            log.error("AttemptAuthentication failed: {}", e.getMessage());
    ...
    protected void successfulAuthentication(HttpServletRequest req, HttpServletResponse res, FilterChain chain, Authentication auth) {
        ...
        log.info("SuccessfulAuthentication, JWT issued : {}", ((User) auth.getPrincipal()).getUsername());
    }
